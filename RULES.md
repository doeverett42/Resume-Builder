## Coding Conventions
  ...
  - **Async Javascript**: Prefer to use async awaith rather than .then when performing asynchronous javascript functions
...
## Accessibility
  ...
  - **ARIA Labels**: Include aria lables on ALL HTML form controls 
...
## API Requirements
  ...
  - **Status Codes**: Every routes should return appropriate HTTP status codes for both success and error
